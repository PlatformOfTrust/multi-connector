...
const publicKeyURLs = [
    ...
    },
    {
        version: 'v2',
        env: 'production',
        url: 'https://api.oftrust.net/products/v2/auth/public-key',
    ...
    },
    {
        version: 'v2',
        env: 'sandbox',
        url: 'https://api-sandbox.oftrust.net/products/v2/auth/public-key',
    ...
    },
    {
        version: 'v2',
        env: 'test',
        url: 'https://api-test.oftrust.net/products/v2/auth/public-key',
    ...
    },
    {
        version: 'v2',
        env: 'dev',
        url: 'https://api-dev.oftrust.net/products/v2/auth/public-key',
