*** Settings ***
Documentation     Microsoft 365 Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
${TARGET_OBJECT}             Neuvotteluhuone X
${START_TIME}                2020-11-01T23:00Z
${END_TIME}                  2020-12-31T23:00Z
...
fetch, 200
    ...
    Fetch Data Product    ${body}
    Integer               response status                                         200
    String                response body @context                                  https://standards.oftrust.net/v2/Context/DataProductOutput/Event/
    Object                response body data
    Array                 response body data event
    Object                response body data event 0
    Object                response body data event 0 location
    String                response body data event 0 location @type               Location
    String                response body data event 0 location idLocal             ${TARGET_OBJECT}
...
fetch, 200, Empty targetObject
    ...
    Integer    response status                200
    String     response body @context         https://standards.oftrust.net/v2/Context/DataProductOutput/Event/
    Array      response body data events      maxItems=0
