*** Settings ***
Documentation     Digitraffic Marine API - REST
Library           Collections
Library           DateTime
Library           PoTLib
...
fetch, 200
    ...
    Fetch Data Product    ${body}
    Integer               response status                                         200
    String                response body @context                                  https://standards.oftrust.net/v2/Context/DataProductOutput/VehicleInformation/PortCallReport/
    Object                response body data
    Array                 response body data portCallReport
    Object                response body data portCallReport 0 transportationTripStop
    String                response body data portCallReport 0 transportationTripStop @type       TransportationTripStop
...
fetch, 200, Empty ids
    [Tags]                 bug-0004
    ${body}                Get Body
    Set To Dictionary      ${body["parameters"]}                ids=[""]
    Fetch Data Product     ${body}
    Integer    response status                200
    String     response body @context         https://standards.oftrust.net/v2/Context/DataProductOutput/VehicleInformation/PortCallReport/
    Array      response body data portCallReport     maxItems=0
