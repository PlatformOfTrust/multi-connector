*** Settings ***
Documentation     Fidelix Pilvivalvomo Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
${ID1}                       VAK02.01_TK06_TE31_M
${ID2}                       VAK01.01_TK06_TE23_M
${ID3}                       VAK02.01_TK06_TE23_M
${ID4}                       VAK01.01_1128_TE20_M
${ID5}                       VAK01.01_1131_TE20_M
${ID6}                       INVALID
