...
fetch, 200
    ...
    Array                 response body data airportSecurityLine
    String                response body data airportSecurityLine 0 @type       Measure
...
fetch, 200, Empty targetObject
    ...
    Integer    response status                200
    String     response body @context         https://standards.oftrust.net/v2/Context/DataProductOutput/Process/Measure/AirportSecurityLine/
    Array      response body data airportSecurityLine     maxItems=0
