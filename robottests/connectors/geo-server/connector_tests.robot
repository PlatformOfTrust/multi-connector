*** Settings ***
Documentation     GeoServer Web Feature Service Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
&{ADDITIONAL_PROPS}          filter-lang=cql-text
&{TARGET_OBJECT}             idLocal=helsinki_rakennukset  lowLeftCornerCoordinateAxis2=60.185  lowLeftCornerCoordinateAxis1=24.829  upperRightCornerCoordinateAxis2=60.296  upperRightCornerCoordinateAxis1=25.357  additionalProps=${ADDITIONAL_PROPS}
${START_TIME}                2018-02-12T23:20:50Z
${END_TIME}                  2018-03-12T23:20:50Z
...
fetch, 200
    ...
    Fetch Data Product    ${body}
    Integer               response status                                         200
    String                response body @context                                  https://standards.oftrust.net/v2/Context/DataProductOutput/BuildingInformation/
    Object                response body data
    Array                 response body data buildings
    String                response body data buildings 0 @type                    Building
...
fetch, 422, Missing data for ids required field
    ...
    Integer    response status                                  422
    Integer    response body error status                       422
    String     response body error message parameters.targetObject.idLocal 0     Missing data for required field.
...
fetch, 200, Empty ids
    [Tags]                 bug-0005
    ${body}                Get Body
    Set To Dictionary      ${body["parameters"]["targetObject"]}                idLocal=NA
    Fetch Data Product     ${body}
    Integer    response status                200
    String     response body @context         https://standards.oftrust.net/v2/Context/DataProductOutput/BuildingInformation/
    Array      response body data buildings   maxItems=0
