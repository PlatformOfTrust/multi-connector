*** Settings ***
Documentation     Nuuka Solutions Platform Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
${ID1}                       1000 Hakaniemen kauppahalli
${ID2}                       INVALID
@{IDS}                       ${ID1}  ${ID2}
${START_TIME}                2020-01-31T21:51:16.831Z
${END_TIME}                  2020-05-20T12:20:56.000Z
...
fetch, 200
    ...
    String                response body data sensors 0 measurements 0 @type       MeasureEnergyConsumptionKilowattHour
