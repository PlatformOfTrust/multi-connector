*** Settings ***
Documentation     Schneider EcoStruxure Cloud Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
${ID1}                       01/eValvomo/Demoasiakkuus/Demo site/Tasokuvat 2 kerros/Huoneet/Huone 202/Muuttujat/CO2-pitoisuus
${ID2}                       INVALID
@{IDS}                       ${ID1}  ${ID2}
${START_TIME}                2020-04-06T06:28:30.111Z
${END_TIME}                  2020-04-07T10:18:30.111Z
