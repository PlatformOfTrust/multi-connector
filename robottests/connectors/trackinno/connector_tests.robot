*** Settings ***
Documentation     Trackinno Service API Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
fetch, 200
    ...
    Fetch Data Product    ${body}
    Integer               response status                                         200
    String                response body @context                                  https://standards.oftrust.net/v2/Context/DataProductOutput/Asset/
    Object                response body data
    Array                 response body data assets
    Array                 response body data assets 0 data
    String                response body data assets 0 data 0 @type              Asset
...
fetch, 200, Empty ids
    ...
    Integer    response status                200
    String     response body @context         https://standards.oftrust.net/v2/Context/DataProductOutput/Asset/
    Array      response body data assets    maxItems=0
