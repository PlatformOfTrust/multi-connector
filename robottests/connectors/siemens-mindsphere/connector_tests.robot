*** Settings ***
Documentation     Siemens Mindsphere Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
&{ID1}                       assetId=e424925968ee477188bbadba5ce0a6f9  aspectId=TEHuoneilmanLampotila
&{ID2}                       assetId=a486c6f5c014473fba831eba3ae24a7b  aspectId=1TEHuoneilmanLampotila
&{ID3}                       assetId=a486c6f5c014473fba831eba3ae24a7b  aspectId=2TEHuoneilmanLampotila
@{IDS}                       ${ID1}  ${ID2}  ${ID3}
