*** Settings ***
Documentation     Orfer API Integration API Tests
Library           Collections
Library           DateTime
Library           PoTLib
...
${CONTEXT}                   https://standards.oftrust.net/v2/Schema/DataProductOutput/Equipment/Device/?v=1.0
&{ID}                        idLocal=C26C4E99-7870-40C7-BB49-EF71FE2AD8C3
@{TARGET_OBJECT}             ${ID}
${START_TIME}                2022-03-20T00:00:00
${END_TIME}                  2022-03-24T00:00:00
...
fetch, 200
    ...
    Array                 response body data device
...
fetch, 200, Empty ids
    ...
    Integer    response status                200
    String     response body @context         ${CONTEXT}
    Array      response body data device     maxItems=0
